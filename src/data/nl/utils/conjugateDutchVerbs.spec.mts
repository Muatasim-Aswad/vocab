...
testSeparableConjugation(
  ...
  'ophalen (to pick up) - separable verb with regular base, separated prefix in finite forms',
);
...
testSeparableConjugation(
  ...
  "voorverwarmen (to preheat) - separable verb with inseparable base 'verwarmen', separated prefix in finite forms",
);
...
testSeparableConjugation(
  ...
  "voorbereiden (to prepare) - separable verb with inseparable base 'bereiden', separated prefix in finite forms",
);
...
try {
  ...
  assert.strictEqual(
    ...
    "Input must be a Dutch infinitive ending in 'en'",
  );
